...
const TeaMenuAdmin = () => {
  ...
  const filteredItems = foodPairingList.filter((item) => {
    return item.bevName.toLowerCase().includes(searchKeyword.toLowerCase()) || item.foodName.toLowerCase().includes(searchKeyword.toLowerCase());
  });
      ...
      <Container fluid>
        <Row style={{ marginTop: "24px" }}>
          <Col md={7} xs={12}>
            ...
            <p className="text-muted teanology-menu-update">Manage your food pairing data on this page.</p>
          </Col>
      ...
      <Row>
        <Col md={8}>
          ...
          <Modal show={showAdd} onHide={handleCloseAdd} backdrop="static" keyboard={false}>
            ...
            <Modal.Body>
              <Form>
                ...
                <Form.Group className="mb-2" controlId="formBasicEmail">
                  ...
                  <Form.Select className="form-data" name="food" value={formData.food} onChange={handleInputChange}>
                    <option value="" disabled selected hidden>
                      Select name
                    </option>
            ...
            <Modal.Footer>
              <Button className="pagination-button btn-light text-light" onClick={submitFoodPairingData}>
                Save
              </Button>
