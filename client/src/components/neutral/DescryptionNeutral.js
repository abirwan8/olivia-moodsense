  ...
  return (
    <div className="desc-box">
      <Card className="shadow-none desc-body">
        <Card.Body>
          <div className="mx-1">
            <Badge className="badge-custom-neutral fw-normal ms-2">{val.type}</Badge>
            <Badge className="badge-custom-neutral fw-normal ms-2">{val.ings}</Badge>
          ...
          <button className="btn btn-pairing-neutral" onClick={() => handleGetFoodClick()}>
            Get Some Food
          </button>
        </Card.Body>
      </Card>
