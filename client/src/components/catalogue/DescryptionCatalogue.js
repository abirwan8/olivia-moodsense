  ...
  return (
    <div className="desc-box">
      <Card className="shadow-none desc-body">
        <Card.Body>
          <div className="mx-1">
            <Badge className="badge-custom-green fw-normal ms-2">{val.type}</Badge>
            <Badge className="badge-custom-green fw-normal ms-2">{val.highlight}</Badge>
            <Badge className="badge-custom-green fw-normal ms-2">Angry</Badge>
          </div>
