  ...
  return (
    <div className="desc-box">
      <Card className="shadow-none desc-body">
        <Card.Body>
          <div className="mx-1">
            <Badge className="badge-custom-surprise fw-normal ms-2">{val.type}</Badge>
            <Badge className="badge-custom-surprise fw-normal ms-2">{val.ings}</Badge>
          ...
          <button className="btn btn-pairing-surprise" onClick={() => handleGetFoodClick()}>
            Get Some Food
          </button>
        </Card.Body>
      </Card>
